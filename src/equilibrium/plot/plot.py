...
def plot_deterministic_results(
    ...
    **kwargs
    ...
    from .preparation import prepare_deterministic_paths

    # Extract label_parts for plot_dir construction
    ...
    # Merge series_transforms from plot_spec if not provided directly
    if series_transforms is None and plot_spec is not None:
        series_transforms = plot_spec.series_transforms

    # Prepare deterministic paths using the extracted preparation function
    ...
    return plot_paths(
        ...
        full_list=prep.var_names,
        include_list=prep.var_names,
        title_str=title_str,
        x_str=x_str,
        prefix=prefix,
